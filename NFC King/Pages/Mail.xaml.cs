...
namespace NFC_King.Pages
{
    ...
    public sealed partial class Mail : Page
    {
        ...
        private async void BtnRecord_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageDialog showDialog = new MessageDialog("Assunto vazio. Preencha o campo de assunto e tente novamente.");
            ...
            else
            {
                ...
                string email = TxtBoxReceiver.Text;
                string assunto = TxtBoxSubject.Text;
                string mensagem = TxtBoxMessage.Text;
